...
Future<void> init() async {
  ...
  sl.registerFactory(() => PatientDetailCubit(patientsRepository: sl()));
  ...
  // Features - Regions
  sl.registerLazySingleton<RegionsRepository>(() => RegionsRepository());

  sl.registerFactory(() => RegionsCubit(sl()));
}
